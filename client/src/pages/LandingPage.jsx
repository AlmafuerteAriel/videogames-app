...
export default function LandingPage() {
    return (
      <div className='landingContent'>
        <img className='landingIcon' className='landingIcon1' src={molecule} alt="line" />
        <img className='landingIcon' className='landingIcon2' src={molecule} alt="line" />
        <h1 className="landingTitle">VIDEOGAMES</h1>
        <img className='landingIcon' className='landingIcon3' src={molecule} alt="line" />
        <img className='landingIcon' className='landingIcon4' src={molecule} alt="line" />
        <Link to='/home'>
        ...
        <img className='landingIcon' className='landingIcon5' src={molecule} alt="line" />
      </div>
    )
  }